...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"育儿指南";
...
- (void)setContainerViewController {
    CareBabyInfoVC *vc1 = [CareBabyInfoVC new];
    [self.mContainerVCArr addObject:vc1];
    CareBabyTimeVC *vc2 = [CareBabyTimeVC new];
    [self.mContainerVCArr addObject:vc2];
    CareBabySoundVC *vc3 = [CareBabySoundVC new];
...
- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:246.0/255.0 green:172.0/255.0 blue:73.0/255.0 alpha:1.0];
}
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:246.0/255.0 green:172.0/255.0 blue:73.0/255.0 alpha:1.0]
                              //title font, size
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if(section == 0){
        ...
        UIColor *bgColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"appbg"]];
