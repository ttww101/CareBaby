...
// 主页列表接
#define INDEX_URL @"http://wp.asopeixun.com:5000/get_post_from_category_id?category_id=185"

// 左侧列表接口
//#define LEFT_URL @"http://wp01.asopeixun.com:5000/get_category_list?app_id=1"
#define LEFT_URL @"http://wp.asopeixun.com:5000/get_category_list?app_id=1124278862"
...
// 浮动广告接口
#define POPUP_AD_URL @"http://wp.asopeixun.com:5000/get_popup_ad?app_id=1124278862"

// 顶端广告栏
#define TOPBAR_URL @"http://wp.asopeixun.com:5000/get_topbar_ad?app_id=1124278862"
...
// 客户信息端口
#define CLIENT_INFO_URL @"http://wp.asopeixun.com:5000/get_client?app_id=1124278862"

// 上传统计信息
#define STAT_INFO_URL @"http://wp.asopeixun.com:5000/statistics_client?app_id=1124278862&raw_data="

// APP_ID
#define APP_ID 1124278862
